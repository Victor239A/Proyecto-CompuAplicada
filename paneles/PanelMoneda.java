...
public class PanelMoneda extends JPanel {
    ...
    public PanelMoneda(VistaPrincipal vista) {
        ...
        comboDesde = new JComboBox<>(new String[]{"USD", "EUR", "MXN", "GTQ"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"USD", "EUR", "MXN", "GTQ"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirMoneda(valor, desde, hacia);
