...
public class PanelLongitud extends JPanel {
    ...
    public PanelLongitud(VistaPrincipal vista) {
        this.vista = vista;
        ...
        JLabel lblTitulo = new JLabel("Conversor de Longitud");
        ...
        comboDesde = new JComboBox<>(new String[]{"m", "km", "cm", "mm", "mi", "yd", "ft", "in"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"m", "km", "cm", "mm", "mi", "yd", "ft", "in"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirLongitud(valor, desde, hacia);
