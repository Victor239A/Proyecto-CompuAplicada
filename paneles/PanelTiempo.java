...
public class PanelTiempo extends JPanel {
    ...
    public PanelTiempo(VistaPrincipal vista) {
        this.vista = vista;
        ...
        JLabel lblTitulo = new JLabel("Conversor de Tiempo");
        ...
        comboDesde = new JComboBox<>(new String[]{"s", "min", "h", "d"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"s", "min", "h", "d"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirTiempo(valor, desde, hacia);
