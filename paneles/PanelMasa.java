...
public class PanelMasa extends JPanel {
    ...
    public PanelMasa(VistaPrincipal vista) {
        this.vista = vista;
        ...
        JLabel lblTitulo = new JLabel("Conversor de Masa");
        ...
        comboDesde = new JComboBox<>(new String[]{"kg", "g", "lb", "oz"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"kg", "g", "lb", "oz"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirMasa(valor, desde, hacia);
