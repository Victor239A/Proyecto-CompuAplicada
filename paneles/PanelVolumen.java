...
public class PanelVolumen extends JPanel {
    ...
    public PanelVolumen(VistaPrincipal vista) {
        ...
        JLabel lblTitulo = new JLabel("Conversor de Volumen");
        ...
        comboDesde = new JComboBox<>(new String[]{"L", "mL", "gal", "oz", "m³"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"L", "mL", "gal", "oz", "m³"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirVolumen(valor, desde, hacia);
