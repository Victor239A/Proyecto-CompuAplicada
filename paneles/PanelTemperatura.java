...
public class PanelTemperatura extends JPanel {
    ...
    public PanelTemperatura(VistaPrincipal vista) {
        this.vista = vista;
        ...
        comboDesde = new JComboBox<>(new String[]{"C", "F", "K"});
        gbc.gridx = 1;
        add(comboDesde, gbc);
        ...
        comboHacia = new JComboBox<>(new String[]{"C", "F", "K"});
        gbc.gridx = 1;
        add(comboHacia, gbc);
        ...
        btnConvertir.addActionListener((ActionEvent e) -> {
            try {
                ...
                double res = vista.getControlador().convertirTemperatura(valor, desde, hacia);
